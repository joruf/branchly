...
class CloneDialog(QDialog):
    ...
    def __init__(
        ...
        self._parent_dir.setToolTip(i18n.t("tip.clone_parent"))
        ...
        browse.setToolTip(i18n.t("tip.clone_browse"))
        ...
        self._folder.setToolTip(i18n.t("tip.clone_folder"))
        ...
        self._category.setToolTip(i18n.t("tip.clone_category"))
