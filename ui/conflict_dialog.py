...
class ConflictDialog(QDialog):
    ...
    def _build_decision_page(self) -> QWidget:
        ...
        self._take_ours.setToolTip(i18n.t("tip.conflict_ours"))
        ...
        self._take_theirs.setToolTip(i18n.t("tip.conflict_theirs"))
        ...
        self._take_both.setToolTip(i18n.t("tip.conflict_both"))
        ...
        self._edit_custom.setToolTip(i18n.t("tip.conflict_custom"))
        ...
        self._apply_all.setToolTip(i18n.t("tip.conflict_apply_all"))
        ...
        self._next.setToolTip(i18n.t("tip.conflict_next"))
    ...
    def _build_finish_page(self) -> QWidget:
        ...
        self._finish_button.setToolTip(i18n.t("tip.conflict_finish"))
